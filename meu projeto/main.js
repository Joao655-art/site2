function getProjects() {
    const urlGitHub = "https://api.github.com/users/Joao655-art/repos"; // Inserir o nome de usuário do seu github
  ...
  function showProjects(data) {
    ...
    data.forEach((repo) => {
      ...
      a.href = repo["https://github.com/Joao655-art?tab=repositories"]; // Link para o repositório no GitHub
      a.target = "_blank";
